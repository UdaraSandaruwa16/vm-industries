			...
			>
				{showMobile && (
					<motion.nav
						...
						className={`scroll-hidden mx-auto flex h-full max-w-[950px] flex-col justify-center overflow-y-scroll pt-[50px] pb-[50px] bg-[#C1A01E] text-[#11111F]`}
					>
						<AiOutlineClose
							color="black"
							size={20}
						...
						/>
						{
							...
							>
								<motion.p
									variants={item}
									tabIndex={0}
									className="flex items-center justify-between cursor-pointer hover:my-hover hover:text-white"
